...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.31.3
...
replace k8s.io/cri-api => k8s.io/cri-api v0.31.3
...
replace k8s.io/mount-utils => k8s.io/mount-utils v0.31.3
